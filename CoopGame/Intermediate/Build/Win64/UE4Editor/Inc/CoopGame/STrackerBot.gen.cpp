...
// End Cross Module References
	DEFINE_FUNCTION(ASTrackerBot::execHandleTakeDamage)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->HandleTakeDamage(Z_Param__HealthComp,Z_Param_Health,Z_Param_HealthDelta,Z_Param_DamageType,Z_Param_InstigatedBy,Z_Param_DamageCauser);
		P_NATIVE_END;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASTrackerBot_HandleTakeDamage_Statics::NewProp__HealthComp_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ASTrackerBot_HandleTakeDamage_Statics::NewProp__HealthComp = { "_HealthComp", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(STrackerBot_eventHandleTakeDamage_Parms, _HealthComp), Z_Construct_UClass_USHealthComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ASTrackerBot_HandleTakeDamage_Statics::NewProp__HealthComp_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ASTrackerBot_HandleTakeDamage_Statics::NewProp__HealthComp_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASTrackerBot_HandleTakeDamage_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASTrackerBot_HandleTakeDamage_Statics::NewProp__HealthComp,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASTrackerBot_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASTrackerBot_HandleTakeDamage, "HandleTakeDamage" }, // 3345042473
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASTrackerBot, 1097695283);
